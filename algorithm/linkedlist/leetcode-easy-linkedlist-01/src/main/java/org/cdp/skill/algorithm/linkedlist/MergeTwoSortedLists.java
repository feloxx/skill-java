package org.cdp.skill.algorithm.linkedlist;

import org.cdp.skill.common.ListNode;
...
public class MergeTwoSortedLists {
  ...
  public static void main(String[] args) {
    ...
    MergeTwoSortedLists self = new MergeTwoSortedLists();

    ListNode test1 = new ListNode(1, new ListNode(2, new ListNode(4)));
    ListNode test2 = new ListNode(1, new ListNode(3, new ListNode(4)));

    ListNode resultTest1 = self.mergeTwoListsRecursive(test1, test2);

    System.out.println(resultTest1.toString());
  }
}